    ...
    <div>
      <div className="text-md text-neutral-900">
        ...
        <p>
          ...
          <a href="https://hume.vt.edu/" className="text-blue-500 no-underline hover:underline">Hume Center</a>.&nbsp;
          I also help organize <a href="https://vthacks.com/" className="text-blue-500 no-underline hover:underline">VTHacks</a>,
          one of the largest student-run hackathons on the East Coast, by leading the development of our website and check-in tools
          that accommodate over 1000 registrants.
        </p>
